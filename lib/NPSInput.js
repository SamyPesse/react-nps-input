...
var NPSInput = React.createClass({
    ...
    render: function render() {
        ...
        var message = service ? 'Hur sannolikt \xE4r det att du skulle rekommendera ' + service + ' till en v\xE4n eller kollega?' : 'Hur sannolikt är det att du skulle rekommendera det här företaget till en vän eller kollega?';
